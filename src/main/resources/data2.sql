...
insert into tokens (confirmation_token, created_date) values ('aaaaa', CURRENT_TIMESTAMP)
...
insert into users (username, password, email, is_account_non_locked, is_account_non_expired, is_enabled, is_credentials_non_expired, token_id) values ('petko', '$2a$10$spu0oUURXlNX6veWtuHP5.bC6FjWrDsBAimM50emGblkLZuGOYDCC', 'petko29@gmail.com', true, true, false, true, 1)
